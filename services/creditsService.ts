...
const getCredits = async (userId: string): Promise<{ used: number; limit: number } | null> => {
...
const useCredits = async (userId: string, amount: number = 1): Promise<boolean> => {
...
const syncCredits = async (userId: string): Promise<{ used: number; limit: number } | null> => {
